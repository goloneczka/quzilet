...
insert into ROOM values
    (@room_id, '111-223', 'test room', FORMATDATETIME('2009-03-03 12:00:00', 'yyyy-MM-dd HH:mm:ss'));


insert into QUESTION values
    (@th_question_id, '111-223-C', 'test question 3', 'ask1', 'ask2', 'ask3', 'ask4', 1, @room_id, null);

insert into QUESTION values
    (@nd_question_id, '111-223-B', 'test question 2', 'ask1', 'ask2', 'ask3', 'ask4', 1, @room_id, @th_question_id);

insert into QUESTION values
    (@st_question_id, '111-223-A', 'test question 1', 'ask1', 'ask2', 'ask3', 'ask4', 1, @room_id, @nd_question_id);
